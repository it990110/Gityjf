...
describe('simple site', () => {
  ...
  it('docs with editUrl', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('foo', 'baz.md'), {
      ...
      title: 'baz',
      editUrl:
        'https://github.com/it990110/gityjf/edit/main/website/docs/foo/baz.md',
      description: 'Images',
      frontMatter: {
        id: 'baz',
        slug: 'bazSlug.html',
...
describe('versioned site', () => {
  ...
  it('translated doc with editUrl', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/en/docusaurus-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/it990110/gityjf/edit/main/website/versioned_docs/version-1.0.0/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated en doc with editUrl and editCurrentVersion=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/en/docusaurus-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/it990110/gityjf/edit/main/website/docs/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      editUrl:
        'https://github.com/it990110/gityjf/edit/main/website/i18n/fr/docusaurus-plugin-content-docs/version-1.0.0/hello.md',
      tags: [],
      unlisted: false,
    });
  });
  ...
  it('translated fr doc with editUrl and editLocalizedFiles=true + editCurrentVersion=true', async () => {
    ...
    await testUtilsLocal.testMeta(path.join('hello.md'), {
      ...
      source:
        '@site/i18n/fr/docusaurus-plugin-content-docs/version-1.0.0/hello.md',
      editUrl:
        'https://github.com/it990110/gityjf/edit/main/website/i18n/fr/docusaurus-plugin-content-docs/current/hello.md',
      tags: [],
      unlisted: false,
    });
  });
