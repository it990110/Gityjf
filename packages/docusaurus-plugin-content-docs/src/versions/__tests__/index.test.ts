      ...
      expect(versionsMetadata).toEqual([
        {
          ...vCurrent,
          editUrl:
            'https://github.com/it990110/gityjf/edit/main/website/docs',
          editUrlLocalized:
            'https://github.com/it990110/gityjf/edit/main/website/i18n/en/docusaurus-plugin-content-docs/current',
        },
        {
          ...v101,
          editUrl:
            'https://github.com/it990110/gityjf/edit/main/website/versioned_docs/version-1.0.1',
          editUrlLocalized:
            'https://github.com/it990110/gityjf/edit/main/website/i18n/en/docusaurus-plugin-content-docs/version-1.0.1',
        },
        {
          ...v100,
          editUrl:
            'https://github.com/it990110/gityjf/edit/main/website/versioned_docs/version-1.0.0',
          editUrlLocalized:
            'https://github.com/it990110/gityjf/edit/main/website/i18n/en/docusaurus-plugin-content-docs/version-1.0.0',
        },
        {
          ...vWithSlugs,
          editUrl:
            'https://github.com/it990110/gityjf/edit/main/website/versioned_docs/version-withSlugs',
          editUrlLocalized:
            'https://github.com/it990110/gityjf/edit/main/website/i18n/en/docusaurus-plugin-content-docs/version-withSlugs',
        },
      ]);
    });
