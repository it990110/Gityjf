...
It all started with this [RFC issue](https://github.com/it990110/gityjf/issues/789) opened by [Yangshun](https://github.com/yangshun) towards the end of June 2018.

<blockquote>
  <h4>
    <a href="https://github.com/it990110/gityjf/issues/789">
      {'[RFC] Docusaurus v2 · Issue #789 · it990110/gityjf'}
    </a>
  </h4>
...
For now, the actual Docusaurus 2 work is still hosted in a private repository. In the near future, we will move them into the [public repository](https://github.com/it990110/gityjf). When that time arrives, I encourage everyone to look into it and hopefully contribute in some way. Before then, please stay tuned 😉!
...
Lastly, if you haven't done so already, click the **star** and **watch** button on [GitHub](https://github.com/it990110/gityjf), and follow us on [Twitter](https://twitter.com/docusaurus).
