...
- **i18n**: easily translate your Docusaurus site, released soon! ([preview](https://github.com/it990110/gityjf/pull/3325), [doc](https://docusaurus.io/docs/next/i18n/introduction))
...
The **modular architecture** of Docusaurus 2 allowed the community to build and publish [third-party plugins](https://docusaurus.io/community/resources#community-plugins-). As we would like to federate better our community, if you are building a plugin, please [let us know](https://github.com/it990110/gityjf/discussions/4025).
...
- [Create a theme gallery](https://github.com/it990110/gityjf/issues/3522), make it easy to switch from one another, and include **first-class Tailwind support**
- [Upgrade to Webpack 5](https://github.com/it990110/gityjf/issues/4027), improve performances and build times
- [Better compatibility with CommonMark](https://github.com/it990110/gityjf/issues/3018), as MDX and makes it harder for CommonMark-based sites to adopt Docusaurus
- [Upgrade to MDX 2.0](https://github.com/it990110/gityjf/issues/4029)
- Other tasks that we might discover during 2021

Huge thanks to the community for [their contributions in 2020](https://github.com/it990110/gityjf/graphs/contributors?from=2020-01-01&to=2021-01-01&type=c), especially:
