...
- 🇸🇮 [#8541](https://github.com/it990110/gityjf/pull/8541) Slovenian
- 🇹🇷 [#8289](https://github.com/it990110/gityjf/pull/8289) Turkish
- 🇮🇷 [#8406](https://github.com/it990110/gityjf/pull/8406) Farsi
- 🇵🇱 [#8525](https://github.com/it990110/gityjf/pull/8525) Polish
- 🇨🇳 [#8423](https://github.com/it990110/gityjf/pull/8423) Chinese
- 🇸🇪 [#8312](https://github.com/it990110/gityjf/pull/8312) Swedish
- 🇻🇳 [#8450](https://github.com/it990110/gityjf/pull/8450) Vietnamese
...
- [#8463](https://github.com/it990110/gityjf/pull/8463) and [#8328](https://github.com/it990110/gityjf/pull/8328): fix some annoying Docusaurus layout issues
- [#8539](https://github.com/it990110/gityjf/pull/8539): Algolia plugin `options.searchPagePath` should be correctly applied to search modal footer
- [#8462](https://github.com/it990110/gityjf/pull/8462): Algolia plugin now makes it easier to transform displayed search results with custom logic
- [#8397](https://github.com/it990110/gityjf/pull/8397): the `deploy` CLI now understands git url `insteadOf` config
