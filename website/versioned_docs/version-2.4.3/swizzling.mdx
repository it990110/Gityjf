...
If you have a **strong use-case for swizzling an unsafe component**, please [**report it here**](https://github.com/it990110/gityjf/discussions/5468) and we will work together to find a solution to make it safe.

:::

## Which component should I swizzle? {#which-component-should-i-swizzle}

It is not always clear which component you should swizzle exactly to achieve the desired result. `@docusaurus/theme-classic`, which provides most of the theme components, has about [100 components](https://github.com/it990110/gityjf/tree/main/packages/docusaurus-theme-classic/src/theme)!
...
4. **Read the [theme source code](https://github.com/it990110/gityjf/tree/main/packages/docusaurus-theme-classic/src/theme)** and use search wisely.
...
We also want to understand better your fanciest customization use-cases, so please [**report them**](https://github.com/it990110/gityjf/discussions/5468).
