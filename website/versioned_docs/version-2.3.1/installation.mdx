...
Docusaurus is essentially a set of npm [packages](https://github.com/it990110/gityjf/tree/main/packages).
...
Read more about monorepos in the [Yarn documentation](https://yarnpkg.com/features/workspaces) (Yarn is not the only way to set up a monorepo, but it's a common solution), or checkout [Docusaurus](https://github.com/it990110/gityjf) and [Jest](https://github.com/facebook/jest) for some real-world examples.
...
Ask for help on [Stack Overflow](https://stackoverflow.com/questions/tagged/docusaurus), on our [GitHub repository](https://github.com/it990110/gityjf), our [Discord server](https://discordapp.com/invite/docusaurus), or [Twitter](https://twitter.com/docusaurus).
