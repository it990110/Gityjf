...
If you can't find a way to create a robust CSS selector, please [report your customization use-case](https://github.com/it990110/gityjf/discussions/5468) and we will consider adding new class names.
...
CSS-in-JS support is a work in progress, so libs like MUI may have display quirks. [Welcoming PRs](https://github.com/it990110/gityjf/issues/1640).
