...
Initialize a new site with `npx create-docusaurus@latest website classic` (like [this one](https://github.com/it990110/gityjf/tree/main/examples/classic)).
...
Please help us complete those **[default translations](https://github.com/it990110/gityjf/tree/main/packages/docusaurus-theme-translations/locales)**.
