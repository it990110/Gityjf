...
In addition, MDX is not [100% compatible with CommonMark](https://github.com/it990110/gityjf/issues/3018). Use the **[MDX playground](https://mdx-git-renovate-babel-monorepo-mdx.vercel.app/playground)** to ensure that your syntax is valid MDX.
...
Currently, the table of contents does not contain the imported Markdown headings. This is a technical limitation that we are trying to solve ([issue](https://github.com/it990110/gityjf/issues/3915)).
