...
This local test step is optional because it will be run by the CI on your release PR ([see](https://github.com/it990110/gityjf/pull/2954/checks?check_run_id=780871959))
...
Example PR: [#3114](https://github.com/it990110/gityjf/pull/5098), using title such as `chore: prepare v2.0.0-beta.0 release`
...
- Go to https://github.com/it990110/gityjf/releases/new
...
See release notes at the following link https://github.com/it990110/gityjf/releases/tag/%VER%
```
...
https://github.com/it990110/gityjf/releases/tag/%VER%
```
